#ifndef FANCY_ASSERT_FANCY_ASSERT_HPP_7S3HQICLS
#define FANCY_ASSERT_FANCY_ASSERT_HPP_7S3HQICLS

#ifdef FANCY_ASSERT_HEADER_ONLY
#define FANCY_ASSERT_INLINE inline
#else
#define FANCY_ASSERT_INLINE
#endif

// preprocessor stuff from hedley. actual code starts at line 1978
...
#endif
#if (                                                                          \
    HEDLEY_HAS_BUILTIN(__builtin_unreachable) &&                               \
...
#endif
#if (                                                                          \
    HEDLEY_MSVC_VERSION_CHECK(19, 0, 23918) &&                                 \
...
#define FANCY_ASSERT_DECLVAL(...)                                              \
  (static_cast < identity_t<__VA_ARGS__> && (*)() > (nullptr)())
  ...
  template <
      ...
      typename enable_if<
          not begin_end<typename std::remove_reference<
              decltype(FANCY_ASSERT_DECLVAL(F)())>::type>::value,
          typename void_t<decltype(FANCY_ASSERT_DECLVAL(F)()())>::type>::type* = nullptr>
  constexpr callback_t(F&& f) noexcept // NOLINT
...
#ifdef FANCY_ASSERT_HEADER_ONLY
#ifndef FANCY_ASSERT_NO_INCLUDE_CPP
#include "fancy_assert.cpp"
#endif
#endif

#endif /* end of include guard FANCY_ASSERT_FANCY_ASSERT_HPP_7S3HQICLS */
